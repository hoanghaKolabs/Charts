...
open class BarLineChartViewBase: ChartViewBase, BarLineScatterCandleBubbleChartDataProvider, NSUIGestureRecognizerDelegate
{
    ...
    internal override func initialize()
    {
        ...
        _longGestureRecognizer = UILongPressGestureRecognizer.init(target: self, action: #selector(longGestureRecognized(_:)))
        _longGestureRecognizer.minimumPressDuration = 0.1
    ...
    @objc fileprivate func longGestureRecognized(_ recognizer: NSUIPanGestureRecognizer)
    {
        if recognizer.state == NSUIGestureRecognizerState.began {
            print("begin tap")
        }
